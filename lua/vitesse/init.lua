...
local function set_terminal_colors()
  ...
  vim.g.terminal_color_5 = colorscheme.syntaxMagenta
  vim.g.terminal_color_6 = colorscheme.syntaxCyan
  ...
  vim.g.terminal_color_12 = colorscheme.blue
  vim.g.terminal_color_13 = colorscheme.syntaxMagenta
  vim.g.terminal_color_14 = colorscheme.syntaxCyan
